...
Properties {
	...
	SubShader {
		...
		float	_OffsetX1, _OffsetZ1, _OffsetX2, _OffsetZ2, _OffsetX3, _OffsetZ3, _OffsetX4, _OffsetZ4,
				_OffsetX5, _OffsetZ5, _OffsetX6, _OffsetZ6, _OffsetX7, _OffsetZ7, _OffsetX8, _OffsetZ8;
		float	_Distance1, _Distance2 , _Distance3, _Distance4,
				_Distance5, _Distance6, _Distance7, _Distance8;
		...
		void vert (inout appdata_full v, out Input o)
		{
			...
			//	dve dimenzije na osnovu kojih menjamo 'y'
			//					zasto ovo pravi krug iz lokalne nule ? 
